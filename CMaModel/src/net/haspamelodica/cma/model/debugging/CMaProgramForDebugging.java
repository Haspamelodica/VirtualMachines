package net.haspamelodica.cma.model.debugging;

import java.util.List;
import java.util.Set;

import net.haspamelodica.cma.model.CMaProgram;

public class CMaProgramForDebugging extends CMaProgram
{
	private final List<InstructionForDebugging>	instructionsForDebugging;
	private final Set<DebuggingLabel>			labels;

	public CMaProgramForDebugging(List<InstructionForDebugging> instructions, Set<DebuggingLabel> labels)
	{
