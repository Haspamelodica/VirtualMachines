...
import net.haspamelodica.cma.model.debugging.DebuggingLabel;
import net.haspamelodica.cma.model.debugging.InstructionForDebugging;
...
public class Assembler
{
	...
	public CMaProgramForDebugging assemble()
	{
		...
		return new CMaProgramForDebugging(instructions, allLabels.stream().map(Label::asDebuggingLabel).collect(Collectors.toSet()));
	}
